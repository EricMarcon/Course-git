...
Your computer must be able to write to git. We choose **SSH authentication** for simplicity.

- In RStudio, Tools / Global Options/ Git-SVN, create a new SSH key (no passphrase).
- Click on *View public key*. Copy the key.
- On GitHub, your accounts, Settings, SSH and GPG keys, Add New SSH Key, paste the key. Name it after your computer.


## GitHub security: PAT

Create a GitHub token for Continuous Integration:
...
- Create a repository on GitHub and retrieve its URL: git@github.com:MyAccount/MyRepo.git
